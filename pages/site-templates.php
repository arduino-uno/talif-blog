              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="card mb-4 shadow-sm">
                    <img src="./images/wordify-1.jpg" class="bd-placeholder-img card-img-top" width="100%" height="225"/>
                    <div class="card-body">
                ...
                <div class="col-md-4">
                  <div class="card mb-4 shadow-sm">
                    <img src="./images/biznews-1.jpg" class="bd-placeholder-img card-img-top" width="100%" height="225"/>
                    <div class="card-body">
                      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
