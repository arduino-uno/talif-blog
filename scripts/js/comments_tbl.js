    // fetch data from MySQL
		var table_comments = $('#comments_data').DataTable({
				...
				"columnDefs":[
						...
						{data: {post_id:'post_id', title:'title', name:'name', email:'email', website:'website', message:'message', created:'created'}, className: 'font-weight-normal', name: 'content', targets:1,
								render: function(data,type,full,meta) {
										return '<div class="media">' +
												'<img class="d-flex m-2 rounded border border-light" src="./images/blog-1.jpg" width="60" alt="Generic placeholder image">' +
