...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_634cd63232b816_21047273',
...
function content_634cd63232b816_21047273 (Smarty_Internal_Template $_smarty_tpl) {
?>    <!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                ...
                <div class="col-lg-8">
                    <!-- News Detail Start -->
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="./category.php?cid=2">CSS3</a>
                                <a class="text-body" href="">10 15, 2022</a>
                            </div>
                            <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">There’s a Cool New Way for Men to Wear Socks and Sandals</h1>
                        ...
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            ...
                            <div class="d-flex align-items-center">
                                <span class="ml-3"><i class="far fa-eye mr-2"></i>5</span>
                                <span class="ml-3"><i class="far fa-comment mr-2"></i>2</span>
                            </div>
                        </div>
                    </div>
                                        <!-- News Detail End -->
