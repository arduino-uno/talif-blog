              ...
              <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdown05">
                                        <a class="dropdown-item" href="./category.php?cid=0">Uncategorized</a>
                                        <a class="dropdown-item" href="./category.php?cid=1">HTML5</a>
                                        <a class="dropdown-item" href="./category.php?cid=2">CSS3</a>
                                        <a class="dropdown-item" href="./category.php?cid=3">Bootstrap</a>
                                      </div>
